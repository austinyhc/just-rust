...
//! *   **Linus Torvalds:** "It's just printing a string to stdout. Don't overthink
//!     it. Make sure it doesn't leak memory and that the binary isn't bloated for no
//!     reason."
//! *   **Donald Knuth:** "There is an inherent beauty in the simplicity of this
